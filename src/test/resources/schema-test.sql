...
CREATE TABLE `subscriptions` (
                                 ...
                                 CONSTRAINT `UK_SUBSCRIPTIONS` UNIQUE (`user_id`, `playlist_id`)
);
...
CREATE TABLE `follows` (
                           ...
                           CONSTRAINT `UK_FOLLOWS` UNIQUE (`followee_id`, `follower_id`)
);
...
ALTER TABLE `notifications`             ADD CONSTRAINT `FK_NOTIFICATIONS_USER`   FOREIGN KEY (`receiver_id`)REFERENCES `users` (`id`);
...
ALTER TABLE `playlist_contents`         ADD CONSTRAINT `FK_PC_PLAYLIST`          FOREIGN KEY (`playlist_id`)REFERENCES `playlists` (`id`);
ALTER TABLE `playlist_contents`         ADD CONSTRAINT `FK_PC_CONTENT`           FOREIGN KEY (`content_id`) REFERENCES `contents` (`id`);
ALTER TABLE `watching_sessions`         ADD CONSTRAINT `FK_WS_USER`              FOREIGN KEY (`watcher_id`) REFERENCES `users` (`id`);
ALTER TABLE `watching_sessions`         ADD CONSTRAINT `FK_WS_CONTENT`           FOREIGN KEY (`content_id`) REFERENCES `contents` (`id`);
ALTER TABLE `subscriptions`             ADD CONSTRAINT `FK_SUB_USER`             FOREIGN KEY (`user_id`)    REFERENCES `users` (`id`);
ALTER TABLE `subscriptions`             ADD CONSTRAINT `FK_SUB_PLAYLIST`         FOREIGN KEY (`playlist_id`)REFERENCES `playlists` (`id`);
...
ALTER TABLE `conversation_participants` ADD CONSTRAINT `FK_PARTICIPANTS_CONV`    FOREIGN KEY (`conversation_id`) REFERENCES `conversations` (`id`);
ALTER TABLE `conversation_participants` ADD CONSTRAINT `FK_PARTICIPANTS_USER`    FOREIGN KEY (`user_id`)    REFERENCES `users` (`id`);
ALTER TABLE `direct_messages`           ADD CONSTRAINT `FK_DM_CONV`              FOREIGN KEY (`conversation_id`) REFERENCES `conversations` (`id`);
...
ALTER TABLE `jwt_sessions`              ADD CONSTRAINT `FK_JWT_USER`             FOREIGN KEY (`user_id`)    REFERENCES `users` (`id`);
